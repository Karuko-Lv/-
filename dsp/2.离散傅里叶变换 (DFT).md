...
3. DFT ：有限长傅立叶变换
	...
	8. 利用 DFT 分析连续信号频谱 **(核心难点)**
		...
		5. 总结：$x(t) \xrightarrow{\color{red}{\text{抗混叠}}} x_0(t) \xrightarrow{\color{green}{\text{抽样}}} x[k] \xrightarrow{\color{red}{\text{加窗}}} x_N[k] \xrightarrow{\color{purple}{\textbf{DFT}}} X[m]$ 对应$\begin{array}{c|c|c} \color{blue}{\textbf{频谱混叠}} & \color{blue}{\textbf{频谱泄漏}} & \color{blue}{\textbf{栅栏现象}} \\ \hline \color{purple}{\text{抽样频率:}} & \color{purple}{\text{采集时间:}} & \color{purple}{\text{DFT点数:}} \\ f_{\text{sam}} \ge 2 f_m & T_p = NT \ge \frac{1}{\Delta f_c} & L \ge \frac{f_{\text{sam}}}{\Delta f_d} \end{array}$$
## 5. 参数选择与计算公式 (计算题核心)
